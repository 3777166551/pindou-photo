...
/**
 * CIEDE2000 实现的数值验证:Sharma, Wu, Dalal (2005) 论文附带的
 * 34 对官方参考色对,允许最大偏差 0.011135。
 * 纯 Java,无 Android 依赖;CI 里直接 javac + java 运行。
 */
public class TestColorMath {

    /** 34 对参考色对(Lab1, Lab2),取自 Sharma et al. 2005 附录 */
    static final double[][][] PAIRS = {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < PAIRS.length; i++) {
            ...
            double want = WANT[i];
            if (Math.abs(got - want) <= 0.0112) {
                pass++;
            } else {
                fail++;
                System.out.println("FAIL pair " + (i + 1) + " got=" + got + " want=" + want);
            }
        }
        System.out.println("CIEDE2000 reference test: " + pass + "/" + (pass + fail) + " passed");
