...
> 新会话/新开发者从这里开始读。最后更新：2026-09-20（v2.60 真机迭代完成:
> 设计合同入库+深色模式+无障碍+引导+自动草稿+一键拼豆+FAB,全部 CI 绿;
> **新会话先读「docs/设计合同.md」,再跑「六、待办清单」GIF bug 与首页后
> 的逐页销号**）

## 一、当前状态快照（2026-09-20,v2.60 真机迭代完成,远端 main=6811182）
